'''
Name: voter_registration.py
Author: Patrick Walsh
Date: 1/16/2021
Purpose: Python program prompts user to fill out a voter registration card,
...
# welcome screen
print("********************************************************\n")
print("WELCOME TO THE PYTHON VOTER REGISTRATION SYSTEM (PYVOTE)")
...
if citizenship == "n":
    print("Sorry! Must be a U.S. citizen to register to vote!\n")
# display message if not 18 or older
if age < 18 and age != 0:
    print("Not old enough to vote! Please try again next election :)\n")

print("THANK YOU FOR USING PYVOTE! HAVE A NICE DAY")
